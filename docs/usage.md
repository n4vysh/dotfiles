...
and restore settings from following files in [misc/firefox/](https://github.com/n4vysh/dotfiles/blob/main/misc/firefox/) directory.

| Addon name                          | File name                                         |
| :---------------------------------- | :------------------------------------------------ |
| [uBlock Origin][ublock-origin-link] | [ublock.txt](https://github.com/n4vysh/dotfiles/blob/main/misc/firefox/ublock.txt)             |
| [LibRedirect][libredirect-link]     | [libredirect.json](https://github.com/n4vysh/dotfiles/blob/main/misc/firefox/libredirect.json) |
| [ZeroOmega][zero-omega-link]        | [zero-omega.bak](https://github.com/n4vysh/dotfiles/blob/main/misc/firefox/zero-omega.bak)     |
| [Translate Web Pages][twp-link]     | [twp.txt](https://github.com/n4vysh/dotfiles/blob/main/misc/firefox/twp.txt)                   |
